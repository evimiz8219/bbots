 ...
 *
 * @param {boolean} afterTrade An optional flag , conditionally enabling displaying some additional data
 *
 ...
 *
 * There might be additional variables to be passed and displayed. (or even using some global variables)
 * This function is a placeholder since it might be changed a lot depending on a given set of parameters.
 */
var ShowTradeSessionStats = function (afterTrade) {
    console.log('--------------------------');
...
//
//     var numberOfTicksToAnalyze = 100;
//
//     while(watch('before')) {
//         console.log('====================================');
//         console.log();
//
//         // DigitStats = ResetStatsList(DigitStats);
//         // DigitPercentStats = ResetStatsList(DigitPercentStats);
//
//         // DigitStats = GetDigitStats(
//         //     GetChunkOfTheList(Bot.getTicks(), numberOfTicksToAnalyze), 10, RealTickLength
//         // );
//         //
//         // console.log('DigitStats', DigitStats);
//         //
//         // DigitPercentStats = GetDigitPercentStats(DigitStats, numberOfTicksToAnalyze);
//         //
//         // console.log('DigitPercentStats', DigitPercentStats);
//         //
//         // Bot.purchase('DIGITODD');
//         //
//         // ShowTradeSessionStats(true);
//     }
//
//     while(watch('during')) {
//     }
